    ...
    return (
        <div className="min-h-screen bg-background text-foreground max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <main className="border-x border-border">
                ...
                >
                    {/* Hero background: subtle grid + iridescent blur blobs */}
                    <div className="absolute inset-0 pointer-events-none" aria-hidden>
                        ...
                        {/* Prism blur blobs */}
                        <div className="absolute -top-32 left-1/4 w-96 h-96 rounded-full bg-violet-500/20 blur-[120px]" />
                        <div className="absolute top-10 right-1/4 w-80 h-80 rounded-full bg-cyan-400/15 blur-[100px]" />
                        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-48 rounded-full bg-rose-400/10 blur-[90px]" />
                        <div className="absolute top-1/2 left-1/3 w-64 h-64 rounded-full bg-amber-300/10 blur-[80px]" />
                    </div>
                    ...
                    {/* Hero image – padded, 16:9, no grid overlay */}
                    <div className="relative z-10 px-4 md:px-6 lg:px-8 pb-4 md:pb-6 lg:pb-8 border-t border-border">
