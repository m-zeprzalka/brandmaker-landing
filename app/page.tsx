...
const features = [
  {
    ...
    title: "Naming & Slogan",
    description:
      "4 propozycje nazw z etymologią, slogan reklamowy oraz tagline.",
    span: "md:col-span-2",
  },
  {
    ...
    description:
      "Brand Story, Archetyp marki, Tone of Voice oraz DNA Twojego biznesu.",
    span: "md:col-span-1",
  },
  {
    ...
    description:
      "3 warianty w wybranym stylu. Pliki SVG (wersja wektorowa) gotowe do druku.",
    span: "md:col-span-1",
  },
  {
    ...
    description:
      "Palety Primary/Secondary/Accent, testy WCAG, pełne skale 50–950 i gradienty.",
    span: "md:col-span-2",
  },
  {
    ...
    title: "Typografia",
    description:
      "Dobór fontów (Heading + Body), hierarchia typograficzna, interlinia i specimen.",
    span: "md:col-span-1",
  },
  {
    ...
    title: "Design Tokens",
    description:
      "Dla developerów: gotowy kod CSS, konfiguracja Tailwind i JSON dla Figmy.",
    span: "md:col-span-1",
  },
  {
    ...
    description:
      "Wizualizacje wizytówek, papieru firmowego i strony WWW w wersji MVP.",
    span: "md:col-span-1",
  },
  {
    icon: <Users className="h-5 w-5" />,
    title: "Social Media",
    description:
      "Prezentacja brandingu w mediach społecznościowych – mockupy profili i postów.",
    span: "md:col-span-1",
  },
  {
    ...
    description:
      "Kompletna dokumentacja w formacie prezentacji PDF 16:9. Twoja strategia w pigułce.",
    span: "md:col-span-2",
  },
];
      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border border-border px-4 md:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button size="sm" asChild className="text-sm rounded-sm">
      ...
      <main className="border-x border-border">
        ...
        >
          ...
          <div className="border-b border-border md:border-b-0 md:border-r border-border p-4 md:p-6 lg:p-8 flex flex-col gap-6">
            ...
            {/* Trust signals */}
            <div className="grid grid-cols-[1fr_auto_1fr_auto_1fr] items-center border w-full rounded-md">
          ...
          <div className="bg-muted/30 flex flex-col items-center justify-center p-4 md:p-6 lg:p-8 gap-4 min-h-[340px] relative overflow-hidden">
            ...
            {/* Mock BrandBook card */}
            <div className="relative z-10 w-full max-w-xs border border-border bg-background p-5 flex flex-col gap-3 rounded-md">
              <div className="flex items-center justify-between">
                <span className="text-[10px] uppercase tracking-widest text-muted-foreground font-medium">BrandBook</span>
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-md bg-foreground flex items-center justify-center text-background text-lg font-bold flex-shrink-0">A</div>
                <div>
                  <p className="text-sm font-semibold tracking-tight">Arcadia Studio</p>
                  <p className="text-xs text-muted-foreground">Creative Agency · Premium</p>
                </div>
              </div>
              <div className="grid grid-cols-4 gap-1.5 pt-1">
                {["bg-foreground", "bg-muted-foreground/50", "bg-muted-foreground/25", "bg-muted-foreground/10"].map((bg, i) => (
                  <div key={i} className={`h-6 ${bg} rounded-sm`} />
                ))}
              </div>
              <div className="flex gap-1.5">
                <div className="h-1.5 w-8 bg-foreground rounded-full" />
                <div className="h-1.5 w-12 bg-muted-foreground/30 rounded-full" />
                <div className="h-1.5 w-6 bg-muted-foreground/20 rounded-full" />
              </div>
              <div className="space-y-1">
                {[70, 50, 85].map((w, i) => (
                  <div key={i} className={`h-1 bg-muted-foreground/20 rounded-full`} style={{ width: `${w}%` }} />
                ))}
              </div>
            </div>

            {/* Badge floating */}
            <div className="relative z-10 w-full max-w-xs flex items-center justify-center gap-2 border border-border bg-background/90 backdrop-blur-sm px-3 py-1.5 text-xs rounded-md">
              <Wand2 className="h-3 w-3 text-muted-foreground" />
              <span className="text-muted-foreground">Wygenerowano w <strong className="text-foreground">14 min 22 s</strong></span>
            </div>
          </div>
        </section>
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  {"badge" in plan && plan.badge && (
                    <span className="text-[10px] uppercase tracking-widest font-semibold border border-background/40 text-background px-2 py-0.5">
                      {plan.badge}
                    </span>
                  )}
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 border-b border-border">
            ...
            <div className="border-b sm:border-b-0 sm:border-r border-border p-4 md:p-6 lg:p-8 flex flex-col gap-3 sm:col-span-2 md:col-span-1">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed max-w-48">
                Twoja cyfrowa Agencja Brandingowa. Od pomysłu do pełnego BrandBooka
                w kilka minut.
              </p>
            </div>
            ...
            <div className="p-4 md:p-6 lg:p-8 flex flex-col justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Pierwszy branding całkowicie za darmo. Bez karty kredytowej.
                </p>
              </div>
