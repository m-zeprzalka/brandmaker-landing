            ...
            <main className="border-x border-border">
                ...
                >
                    <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
                        {/* Twoja siatka */}
                        <div className="absolute inset-0 opacity-[0.01] [background-image:linear-gradient(to_right,currentColor_1px,transparent_1px),linear-gradient(to_bottom,currentColor_1px,transparent_1px)] [background-size:20px_20px]" />

                        {/* PRYZMAT - Intensywne pasma */}
                        <div className="absolute top-0 left-0 right-0 h-[150px] flex justify-center translate-y-[-10%] scale-110">

                            {/* Czerwony / Różowy */}
                            <div className="absolute left-[0%] w-[45%] h-full bg-[#FF0055] blur-[100px] opacity-60 rounded-full rotate-[-15deg]" />

                            {/* Pomarańcz / Żółty */}
                            <div className="absolute left-[20%] w-[40%] h-full bg-[#FFB800] blur-[90px] opacity-70 rounded-full rotate-[-5deg]" />

                            {/* Zielony / Turkus */}
                            <div className="absolute left-1/2 -translate-x-1/2 w-[35%] h-full bg-[#00FFAA] blur-[110px] opacity-65 rounded-full" />

                            {/* Niebieski */}
                            <div className="absolute right-[20%] w-[40%] h-full bg-[#0066FF] blur-[90px] opacity-70 rounded-full rotate-[5deg]" />

                            {/* Fiolet */}
                            <div className="absolute right-[0%] w-[45%] h-full bg-[#AA00FF] blur-[100px] opacity-60 rounded-full rotate-[15deg]" />

                        </div>

                        {/* Ten element sprawia, że gradient nie kończy się nagle, tylko miękko znika */}
                        <div className="absolute top-[100px] left-0 right-0 h-[300px] bg-gradient-to-b from-transparent to-white/0" />
                    </div>
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center px-4 md:px-6 lg:px-8 pt-16 pb-10 md:pt-24 md:pb-12 lg:pt-32 lg:pb-16 gap-6 max-w-3xl mx-auto">
                        ...
                        >
                            ...
                            <span>gotowy w kilka minut.</span>
                        </h1>
                    ...
                    <div className="relative z-10 px-4 md:px-6 lg:px-8 pb-4 md:pb-6 lg:pb-8">
                        <div className="aspect-video w-full overflow-hidden rounded-sm max-w-5xl mx-auto">
                            <Image
                                src="/hero.png"
